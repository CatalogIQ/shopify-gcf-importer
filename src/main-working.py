...
"""
The function is designed to synchronize products from CatalogIQ to Shopify using the new 2024-04 products API which allows a large number of options. It is offered as an example. Your actual implementation will vary. There are no warranties or guarantees provided with this code. It is provided as an example to help you get started with your own implementation.
...
topic_path = publisher.topic_path('bitnami-ttqjdimqca', 'demo-shopify-connector')
...
def sync_products_to_shopify(shopify_graphql_url, shopify_headers, ciq_product):
    ...
    print(f"ShetProduct Response: {prod_response_json}")
